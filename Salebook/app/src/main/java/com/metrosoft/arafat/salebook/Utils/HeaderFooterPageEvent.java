...
public class HeaderFooterPageEvent  extends PdfPageEventHelper {
    ...
    public void onOpenDocument( Document document,PdfWriter writer) {
    ...
    private void addHeader(PdfWriter writer){
        ...
        try {
            ...
            // add image
            Image logo = Image.getInstance(HeaderFooterPageEvent.class.getResource("/npoloy.bmp"));
           // Image img = Image.getInstance(getR R.drawable.npoly);
            header.addCell(logo);
